...
urlpatterns = [
    ...
    url(r'^details/(?P<superuser_id>[0-9]+)/(?P<modelstate>.*)/$', views.details.as_view(), name = 'details'),
    url(r'^details/(?P<superuser_id>[0-9]+)/$', views.details.as_view(), name = 'details'),

    url(r'^delete/(?P<superuser_id>[0-9]+)/(?P<modelstate>.*)/$', views.delete.as_view(), name = 'delete'),
